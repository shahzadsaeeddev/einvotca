...
def invoices(business, invoiceType, **data):
...
<ext:UBLExtensions>
    ...
    <cac:AdditionalDocumentReference>
        <cbc:ID>PIH</cbc:ID>
        <cac:Attachment>
            <cbc:EmbeddedDocumentBinaryObject mimeCode="text/plain">""" + data['additionalDocumentReference']['pih'] + """</cbc:EmbeddedDocumentBinaryObject>
        </cac:Attachment>
    </cac:AdditionalDocumentReference>
    <cac:AdditionalDocumentReference>
        <cbc:ID>QR</cbc:ID>
...
<cac:AccountingSupplierParty>
        <cac:Party>
            <cac:PartyIdentification>
                <cbc:ID schemeID='""" + data['accountingSupplierParty']['schema'] + """'>""" + data['accountingSupplierParty']['id'] + """</cbc:ID>
            </cac:PartyIdentification>
            <cac:PostalAddress>
    ...
    <cac:AccountingCustomerParty>
        <cac:Party>
            <cac:PartyIdentification>
                <cbc:ID schemeID='""" + data['accountingCustomerParty']['schema'] + """'>""" + data['accountingCustomerParty']['id'] + """</cbc:ID>
            </cac:PartyIdentification>
            <cac:PostalAddress>
